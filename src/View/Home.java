...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        //if (jumTransaksi==0){
            //    ObjectTransaksi = new Object[1][7];
            //}else{
            //    ObjectTransaksi = new Object[jumTransaksi][7];
            //}
        //System.out.println("Jumlah transaksi sesuai idadmin:"+jumTransaksi);
        ...
        //System.out.println("size listTransaksi:"+listTransaksi.size());
        ...
        for (int i=0; i<listTransaksiSesuaiAdmin.size();i++){
            ...
            //    if (listTransaksi.get(i).getIdAdmin()== Login.adminId){
                //        System.out.println("Masuk data transaksi");
                for (int j=0;j<9;j++){
                    if (j==0){
